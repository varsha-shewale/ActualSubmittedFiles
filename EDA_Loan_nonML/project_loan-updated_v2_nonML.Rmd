...
ggplot(data = loan, aes(Term))+geom_bar(aes(y=100*(..count..)/sum(..count..)))+
  ggtitle("% of borrowers in each term category")+
  scale_x_unit(unit ="months")+
  labs(y = '%')
```
...
ggplot(data = loan, aes(EmploymentStatus))+
  ...
  guides(fill=guide_legend(title="Defaulted/Chargedoff vs. others"))+
  labs(y="%")+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
...
ggplot(data = loan, aes(CreditScoreMean))+geom_histogram(binwidth = 70)+
  ...
  ggtitle("Credit Score (mean) Distribution")
```

```{r echo=FALSE, warning = FALSE}
ggplot(data = loan, aes(x = "", y = CreditScoreMean))+geom_boxplot()+
  ggtitle("Credit Score (mean)")
...
ggplot(data = loan, aes(DelinquenciesLast7Years))+geom_histogram(binwidth = 2)+
  ...
  ggtitle("Delinquencies in last 7 years")
...
ggplot(data = loan, aes(DelinquenciesLast7Years))+
  ...
  ggtitle("Delinquencies in last 7 years (log scale)")
...
ggplot(data = loan, aes(x="", y=StatedMonthlyIncome))+geom_boxplot(alpha = 0.1)+
    scale_y_unit(unit = 'USD')+
    ggtitle("Stated Monthly Income distribution")
...
ggplot(data = loan, aes(x = CreditScoreMean, y = LoanOriginalAmount))+
  geom_point()+
  scale_y_unit(unit = 'USD')+
  ggtitle("Loan Amount vs. Credit Score (mean)")
...
ggplot(data = loan.low_credit,aes(x = LoanStatus))+
  geom_bar(aes(y=100*(..count..)/sum(..count..)))+
  ggtitle("Loan Status for borrowers with credit score (mean) <= 10")
...
#Borrowers with credit score mean > 10
...
ggplot(data = loan.low_credit_defChar,aes(x = EmploymentStatus))+
  geom_bar()+
  ggtitle("Employment Status of low credit borrowers who defaulted/chargedoff")
...
ggplot(data = loan.low_credit_defChar, aes(x = Occupation))+
  ...
  ggtitle("Occupations of low credit borrowers who defaulted/chargedoff")
...
ggplot(data = loan.low_credit_defChar, aes(StatedMonthlyIncome))+
  geom_histogram()+
  scale_x_unit(unit = 'USD')+
  ggtitle("Monthly Income of low credit borrowers who defaulted/chargedoff")
...
ggplot(data = loan.low_credit_non_defChar,aes(x = "",y = StatedMonthlyIncome))+
  geom_boxplot()+
  scale_y_unit(unit = 'USD')+
  ggtitle("Monthly Income of low credit borrowers NOT defaulted/chargedoff")
...
ggplot(data = t, aes(x=variable, y= value))+geom_boxplot()+
  coord_cartesian(ylim = c(0,10000))+
  scale_y_unit(unit = 'USD')+
  ggtitle("Income of low credit borrowers - defaulted/chargedoff vs. NOT defaulted/chargedoff")
...
ggplot(data = loan, aes(y = CreditScoreMean,x=DelinquenciesLast7Years))+
  ...
  ggtitle("Credit Score (mean) vs. Delinquencies in last 7 Years")
...
ggplot(data = loan, aes(y = StatedMonthlyIncome,x=DelinquenciesLast7Years))+
  ...
  scale_y_unit(unit = 'USD')+
  ggtitle("Monthly Income (log scale) vs. Delinquencies in last 7 Years")
...
ggplot(data = loan, aes(y = StatedMonthlyIncome,x=DelinquenciesLast7Years))+
  ...
  coord_cartesian(ylim = c(1000,10000))+
  scale_y_unit(unit = 'USD')+
  ggtitle("Monthly Income vs. Delinquencies in last 7 Years")
...
ggplot(data = loan, aes(y = DebtToIncomeRatio,x=DelinquenciesLast7Years))+
  ...
  ggtitle("Debt-to-Income Ratio vs. Delinquencies in last 7 Years")
```
...
ggplot(data = loan, aes(y = LoanOriginalAmount,x=DelinquenciesLast7Years))+
  geom_point(alpha = 0.7)+
  scale_y_unit(unit = 'USD')+
  ggtitle("Loan Amount vs. Delinquencies in last 7 Years")
```
...
ggplot(loan, aes(y = LoanStatus,x = DelinquenciesLast7Years))+geom_point()+
  ggtitle("Loan Status vs. Delinquencies in last 7 Years")
...
ggplot(loan.deliquent, aes(x= LoanStatus))+
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Loan Status (%) among borrowers with past delinquencies")
```
...
ggplot(data = loan, aes(EmploymentStatus))+
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Employment Status (%) of defaulted/chargedoff borrowers")
...
ggplot(loan.unemp,aes(x=LoanStatus))+
  geom_bar(aes(y=100*(..count..)/sum(..count..)))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Loan Status (%) of unemployed borrowers")
...
ggplot(loan.emp,aes(x=LoanStatus))+
  geom_bar(aes(y=100*(..count..)/sum(..count..)))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Loan Status (%) of employed borrowers")
...
ggplot(data = loan.unemp, aes( x=Occupation))+geom_bar()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Occupations of unemployed borrowers")
...
```{r echo=FALSE, warning = FALSE}
ggplot(data = subset(loan.unemp, Occupation != 'Other'), aes( x=Occupation))+
  geom_bar()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Occupations of unemployed borrowers")
...
ggplot(aes(y = LoanOriginalAmount, x =""), data = loan.unemp) +
  geom_boxplot()+
  scale_y_unit(unit = 'USD')+
  ggtitle("Loan Amounts borrowed by unemployed borrowers")
...
ggplot(data = loan.student, aes(x = EmploymentStatus))+ geom_bar()+
  ggtitle("Employment Status of student borrowers")
...
ggplot(data = loan.student, aes(x = LoanOriginalAmount))+ 
  ...
  scale_x_unit(unit = 'USD')+
  ggtitle("Loan Amounts of student borrowers")
...
ggplot(data = loan,aes(x = ListingCategory))+
  geom_bar()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Borrowers by Loan categories")
...
ggplot(data = loan.debtConsolidate,aes(x = LoanStatus))+
  geom_bar(aes(y=100*(..count..)/sum(..count..)))+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+  
  ggtitle("Loan Status (%) for debt consolidation as loan category")
...
ggplot(data = loan.student,aes(x = ListingCategory))+
  geom_bar()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Student borrowers by Loan categories")
...
ggplot(data = loan.unemp, aes(x=ListingCategory))+
  geom_bar()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1))+
  ggtitle("Unemployed borrowers by Loan categories")
...
term_info <- c("12" = "Term: 12 months", "36" = "Term: 36 months",
               "60" = "Term: 60 months")

ggplot(data = loan, aes(x = CreditScoreMean, y = LoanOriginalAmount))+
  geom_point(alpha = 0.1)+
  facet_wrap(~Term,labeller = as_labeller(term_info))+
  scale_y_unit(unit = 'USD')+
  ggtitle("Loan Amount by CreditScoreMean and term")
```
...
ggplot(data = loan.high_credit,aes(x = "",y = LoanOriginalAmount))+
  ...
  facet_wrap(~Term,labeller = as_labeller(term_info))+
  scale_y_unit(unit = 'USD')+
  ggtitle("Loan Amount of borrowers with high CreditScoreMean")

ggplot(data = loan.high_credit,aes(x = "",y = CreditScoreMean))+
  geom_boxplot()+
  facet_wrap(~Term,labeller = as_labeller(term_info))+
  ggtitle("Borrowers with high CreditScoreMean")
...
I was able to add proper names and units for faceted variable 'Term'.
...
ggplot(data = loan.ls,aes(x = CreditScoreMean,y = LoanOriginalAmount))+
  ...
  scale_y_unit(unit = 'USD')+
  ggtitle("Loan Amount based on CreditScoreMean")
